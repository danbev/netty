...
public class WebSocketHAProxyHandshakerTest {
    ...
    public void isHAProxyRequest() {
        assertThat(WebSocketHAProxyHandshaker.isHAProxyRequest(wsUpgradeRequest()), is(true));
        assertThat(WebSocketHAProxyHandshaker.isHAProxyRequest(wsUpgradeRequestWithBody()), is(false));
    }
    ...
    public void haProxyUpgradeRequest() throws Exception {
        ...
        assertThat(response.headers().get(CONNECTION), equalTo(HttpHeaderValues.UPGRADE.toString()));
        assertThat(response.headers().get(UPGRADE), equalTo(HttpHeaderValues.WEBSOCKET.toString()));
